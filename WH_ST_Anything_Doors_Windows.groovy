...
//        attribute "livingRoomWindow", "string"
        attribute "bfstNookWindow", "string"       
        attribute "diningRoomWindow", "string"       
        attribute "masterWindow1", "string"       
        attribute "masterWindow2", "string"       
        attribute "masterBathWindow", "string"       
...
//            state("closed", label:'${name}', icon:"st.contact.contact.closed", backgroundColor:"#79b821")
//         }
//        standardTile("livingRoomWindow", "device.livingRoomWindow", width: 1, height: 1, canChangeIcon: true, canChangeBackground: true) {
//            state("open", label:'${name}', icon:"st.contact.contact.open", backgroundColor:"#ffa81e")
//            state("closed", label:'${name}', icon:"st.contact.contact.closed", backgroundColor:"#79b821")
//         }
        standardTile("bfstNookWindow", "device.bfstNookWindow", width: 1, height: 1, canChangeIcon: true, canChangeBackground: true) {
            state("open", label:'${name}', icon:"st.contact.contact.open", backgroundColor:"#ffa81e")
            state("closed", label:'${name}', icon:"st.contact.contact.closed", backgroundColor:"#79b821")
         }
        standardTile("diningRoomWindow", "device.diningRoomWindow", width: 1, height: 1, canChangeIcon: true, canChangeBackground: true) {
            state("open", label:'${name}', icon:"st.contact.contact.open", backgroundColor:"#ffa81e")
            state("closed", label:'${name}', icon:"st.contact.contact.closed", backgroundColor:"#79b821")
         }
        ...
        standardTile("masterBathWindow", "device.masterBathWindow", width: 1, height: 1, canChangeIcon: true, canChangeBackground: true) {
            state("open", label:'${name}', icon:"st.contact.contact.open", backgroundColor:"#ffa81e")
            state("closed", label:'${name}', icon:"st.contact.contact.closed", backgroundColor:"#79b821")
         }
...
//        }
        ...
        main (["diningRoomWindow"])
        details(["bfstNookWindow","diningRoomWindow","masterWindow1","masterWindow2","masterBathWindow"])
